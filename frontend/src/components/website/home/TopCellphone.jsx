...
function TopCellphone() {
  const category = [
    { name: "iPhone (iOS)", pera: "74 Items", img: "/images/pop1.png" },
    { name: "Android", pera: "35 Items", img: "/images/pop1.png" },
    { name: "5G Support", pera: "12 Items", img: "/images/pop1.png" },
    { name: "Gaming", pera: "9 Items", img: "/images/pop1.png" },
    { name: "Xiaomi", pera: "52 Items", img: "/images/pop1.png" },
    { name: "Accessories", pera: "29 Items", img: "/images/pop1.png" },
  ]; 
   const slider = [
    {
      img: "/images/home/deals1.png",
  ...
  return (
    <div className="p-4 sm:p-5 bg-white rounded-[10px] my-5">
      ...
      <div className="py-5 flex flex-col lg:flex-row gap-6 border-b border-[#99999944] ">
        {/* Left Banner */}
        <div className="bg-[url('/images/hero2.png')] w-full lg:w-1/2 rounded-[10px] bg-cover bg-center h-[200px] sm:h-[250px]">
          <div className="px-5 sm:px-7 py-6 flex flex-col justify-between h-full">
            <div>
              <h1 className="text-[18px] sm:text-[20px] lg:text-[22px] font-medium leading-6 lg:leading-7 mb-2.5">
            ...
            <button className="mt-4 lg:mt-0 bg-black text-white py-[6px] px-[14px] rounded-[8px] text-[12px] font-medium cursor-pointer self-start lg:self-end">
              SHOP NOW
            </button>
          </div>
        </div>
